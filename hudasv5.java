...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\u001B[31m╚═╝░░╚═╝░╚═════╝░╚═════╝░╚═╝░░╚═╝╚═════╝░");
        System.out.println("\n");
        System.out.print("\u001B[32mIlagay muna Puke web mo: \u001B[37m");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("SIMULAN NA PAG BAYO SA PUKE WEB MO: " + url);

        String[] SUrl = url.split("://");

        System.out.println("Checking kung may bata na sa puke web mo");
